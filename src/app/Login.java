...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Login_button.setBackground(new java.awt.Color(255, 153, 153));
        Login_button.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        Login_button.setForeground(new java.awt.Color(51, 0, 51));
        ...
        Signup_button.setBackground(new java.awt.Color(51, 0, 51));
        Signup_button.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        Signup_button.setForeground(new java.awt.Color(228, 123, 77));
        Signup_button.setText("Вход за служители");
    ...
    private void Login_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Login_buttonActionPerformed
        ...
        if (user.equals("client") && pass.equals("1234")){
    ...
    private void Signup_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Signup_buttonActionPerformed
        Login_employee empLogin = new Login_employee();
